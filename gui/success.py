...
class Success:
    '''
    Contains functions to create the Success screen of the GUI,
    and link the Success screen to the main menu of the GUI
    '''
    def __init__(self, parent, menu, mainMenu):
        ...
        # Add the Success text to the screen and render it
        title = ttk.Label(self.success, text='Success')
        title.grid(row=0, column=0)
        
        # Add the text to the Frame and render it
    ...
    def show(self):
        '''
        Place the Success frame in the parent Frame and bring it to the front to show it
    ...
    def hide(self):
        '''
        Remove the Success frame from the parent Frame and bring the main menu to the front to show it
